...
public class VoteBuilderTest {
	...
	public void shallFailBecauseOfNullContent() {
		...
		new VoteBuilder().withIndicator(indicator).withUser(user).withValue(50)
				.build();
	}
	...
	public void shallFailBecauseOfNullIndicator() {
		...
		new VoteBuilder().withContent(content).withUser(user).withValue(50)
				.build();
	}
	...
	public void shallFailBecauseOfNullUser() {
		...
		new VoteBuilder().withContent(content).withIndicator(indicator)
				.withValue(50).build();
	}
