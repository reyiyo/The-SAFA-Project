                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="tag" action="show" id="${resourceInstance?.resourceType?.id}">${resourceInstance?.resourceType?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="resource.size.label" default="Size" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: resourceInstance, field: "size")}</td>
