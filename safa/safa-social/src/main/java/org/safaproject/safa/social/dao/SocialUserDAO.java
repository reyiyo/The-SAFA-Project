...
/**
 * Data access methods used for implementing Spring Social's ConnectionRepository
 ...
 * In this application users are not allowed to associate one social account
 * with multiple local accounts. They will get an error if they attempt to do so.
 * Similarly attempting to connect two social accounts from the same provider 
