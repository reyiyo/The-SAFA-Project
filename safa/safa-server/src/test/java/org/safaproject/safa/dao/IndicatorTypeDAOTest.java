...
public class IndicatorTypeDAOTest {
	...
	public void shallCreateIndicatorType() {
		IndicatorType indicatorType = new IndicatorTypeBuilder()
				.withIndicatorName("WTFperMINUTE").withMaxValue(20)
				.withMinValue(5).build();
		indicatorTypeDAO.save(indicatorType);

		IndicatorType indicatorTypeFromDB = indicatorTypeDAO
				.findById(indicatorType.getIndicatorName());
	...
	public void shallFindAll() {
		IndicatorType indicatorType = new IndicatorTypeBuilder()
				...
				.withMinValue(5).build();
		indicatorTypeDAO.save(indicatorType);
		IndicatorType indicatorType2 = new IndicatorTypeBuilder()
				.withIndicatorName("LCDTOMperMINUTE").withMaxValue(10)
				.withMinValue(2).build();
	...
	public void shallUpdateIndicatorType() {
		...
		Assert.assertEquals(newMaxValue, indicatorTypeDAO.findAll().get(0)
				.getMaxValue());
	}
	...
	public void shallFailBecauseOfNullName() {
		IndicatorType indicatorType = new IndicatorTypeBuilder()
				.withIndicatorName(null).withMaxValue(20).withMinValue(5)
				.buildPlaneObject();
		indicatorTypeDAO.save(indicatorType);
	}
	...
	public void shallFailBecauseOfNullMinValue() {
		IndicatorType indicatorType = new IndicatorTypeBuilder()
				.withIndicatorName("WTFperMINUTE").withMaxValue(null)
				.withMinValue(5).buildPlaneObject();
		indicatorTypeDAO.save(indicatorType);
	}
	...
	public void shallFailBecauseOfNullMaxValue() {
		IndicatorType indicatorType = new IndicatorTypeBuilder()
				.withIndicatorName("WTFperMINUTE").withMaxValue(20)
				.withMinValue(null).buildPlaneObject();
		indicatorTypeDAO.save(indicatorType);
	}
}
